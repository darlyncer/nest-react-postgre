      ...
      <div className="mt-10 p-4 rounded-md bg-slate-800">
        ...
        <div className="flex flex-wrap mt-2 items-center gap-2 ">
          {categories.map((category, idx) => (
            ...
            >
              {category.title}
              <div className="absolute hidden items-center justify-between px-3 left-0 top-0 bottom-0 right-0 rounded-lg bg-black/90 group-hover:flex">
                <button
                  onClick={() => {
        ...
        >
          <FaPlus />
          <span>Crate a new category</span>
        </button>
      </div>
